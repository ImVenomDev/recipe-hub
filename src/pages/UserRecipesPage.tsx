...
export default function UserRecipesPage() {
        ...
        const fetchRecipes = async () => {
            try {
                const qSnap = await getDocs(
                    query(collection(db, "recipes"), where("author_id", "==", id), orderBy("createdAt", "desc"))
                );
                console.log(`Fetched ${qSnap.docs.length} recipes for user ${id}`);
    ...
    return (
        <div className="max-w-2xl mx-auto p-4 pt-24 space-y-4">
            ...
            <h1 className="text-2xl font-bold text-purple-700 mb-4">Le tue ricette</h1>
